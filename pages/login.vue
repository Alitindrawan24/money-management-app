    ...
    <div>
        ...
        <div class="flex h-screen overflow-hidden">
            ...
            <div class="relative flex flex-1 flex-col overflow-y-auto overflow-x-hidden">
                ...
                <!-- ===== Main Content Start ===== -->
                <main>
                    <div class="mx-auto mt-24 max-w-screen-md p-4 md:p-6 2xl:p-10">

                        <!-- ====== Forms Section Start -->
                        <div
                            class="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                            <div class="flex flex-wrap items-center">
                                <div class="mx-auto w-full xl:block xl:w">
                                    <div class="px-26 pt-10 text-center">
                                        <NuxtLink class="mb-2 inline-block" to="/">
...
export default {
    setup() {
        ...
        const login = async() => {
            try {
                await useFetch(config.public.apiHost + '/login', {
                    "method": "POST",
                    "body": user,
                }).then((response) => {
