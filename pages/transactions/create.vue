                            ...
                            <div
                                ...
                                <div class="flex flex-col gap-5.5 p-6.5">
                                    <div>
                                        ...
                                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                                            <select
                                                ...
                                                <option disabled selected hidden class="text-body">
                                                    Select Type
                                                </option>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative z-20 bg-transparent dark:bg-form-input">
                                            <select
                                                ...
                                                <option value="salary" class="text-body">Salary</option>
                                                <option value="bonus" class="text-body">Bonus</option>
                                            </select>
                                            <span class="absolute right-4 top-1/2 z-30 -translate-y-1/2">
                                                <svg class="fill-current" width="24" height="24" viewBox="0 0 24 24"
                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" placeholder="Input date transaction"
                                    ...
                                    <div>
                                        ...
                                        <input type="text" placeholder="Input amount transaction"
                                            class="w-full rounded-lg border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <textarea rows="6" placeholder="Input description"
