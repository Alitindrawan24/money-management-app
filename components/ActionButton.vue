<template>
    <div>
        <div class="flex items-center space-x-3.5">
            <NuxtLink :to="show" class="hover:text-primary">
            ...
            <NuxtLink :to="edit" class="hover:text-primary">
                <svg class="fill-current" width="18" height="18" viewBox="0 0 576 512" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
